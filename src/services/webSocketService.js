...
//   /**
//    * Connects to the WebSocket server or starts mock generation.
//    * @param {string} regionId 
//    * @param {function(Object): void} onMessage - Store callback for incoming frames
//    * @param {function(boolean): void} onStatusChange - Store callback for connection state
//    */
//   connect(regionId, onMessage, onStatusChange) {
//     if (!USE_REAL_MODEL) {
//       // Mock Fallback: Emits a simulated nowcast frame every 2 seconds
//       onStatusChange(true);
...
//           hazardType: Math.random() > 0.5 ? 'Cloudburst' : 'Flash Flood',
//           attentionGrid: Array.from({ length: 5 }, () =>
...
//         this.handleReconnect(regionId, onMessage, onStatusChange);
//       };
//     } catch (err) {
...
//   handleReconnect(regionId, onMessage, onStatusChange) {
//     if (this.reconnectAttempts < this.maxReconnectAttempts) {
//       this.reconnectAttempts += 1;
//       const timeout = Math.min(1000 * Math.pow(2, this.reconnectAttempts), 10000);
//       setTimeout(() => {
//         this.connect(regionId, onMessage, onStatusChange);
//       }, timeout);
//     }
//   }
...
//     if (this.socket) {
//       this.socket.onclose = null; // Prevent reconnect loops on intentional close
//       this.socket.close();
//     }
//   }
// }
