...
//             <p className="text-xs text-slate-500">Satellite input and feature contribution attributions</p>
//           </div>
//         </div>
...
//       {/* 3. Plain-language summary — light theme, matches page background */}
//       {currentRiskData?.xaiExplanation && (
//         <div className="p-6 bg-white rounded-2xl border border-purple-200 shadow-sm space-y-3">
