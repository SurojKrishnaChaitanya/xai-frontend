...
//   return (
//     <div className="p-6 bg-slate-900 text-white rounded-xl border border-slate-800 space-y-6 relative overflow-hidden">
//       {isLoading && (
...
//           <h3 className="font-semibold text-slate-200">Simulation Impact Visualizer</h3>
//         </div>
//         <span className="flex items-center gap-1.5 text-xs px-2.5 py-1 bg-slate-800 text-cyan-400 border border-slate-700 rounded-full">
...
//           </div>
//           <div className="text-2xl font-bold text-slate-300">25 / 100</div>
//           <div className="text-xs text-emerald-400 font-medium">Normal Operating Limits</div>
//         </div>
...
//           <div className="text-sm font-semibold">{hazardType}</div>
//         </div>
//       </div>

//       {/* Recharts Visual Comparison */}
//       <div className="space-y-2 pt-2">
//         <div className="text-xs text-slate-400 font-medium">Baseline vs. Simulation Variance</div>
//         <div className="h-44 w-full bg-slate-950/40 p-2 rounded-lg border border-slate-800">
...
//                 <Cell fill="#38bdf8" />
//                 <Cell fill={riskScore > 70 ? '#f43f5e' : riskScore > 40 ? '#fbbf24' : '#10b981'} />
//               </Bar>
//             </BarChart>
//           </ResponsiveContainer>
//         </div>
