...
//   return (
//     <div className="p-5 bg-slate-900 text-white rounded-xl border border-slate-800 space-y-5">
//       <div className="flex justify-between items-center">
//         <h3 className="font-semibold text-slate-200">Simulation Controls</h3>
//         {isLoading && <span className="text-xs text-amber-400 animate-pulse">Executing Model...</span>}
//       </div>

//       <div className="space-y-4">
//         <Slider label="Precipitation Rate" unit="mm/hr" min={0} max={150} value={simulatorParameters.precipitation} onChange={(v) => handleChange('precipitation', v)} />
//         <Slider label="Wind Speed" unit="km/h" min={0} max={180} value={simulatorParameters.windSpeed} onChange={(v) => handleChange('windSpeed', v)} />
//         <Slider label="Integrated Water Vapor (IWV)" unit="kg/m²" min={0} max={100} value={simulatorParameters.iwv} onChange={(v) => handleChange('iwv', v)} />
//         <Slider label="CAPE (Instability)" unit="J/kg" min={0} max={4000} value={simulatorParameters.cape} onChange={(v) => handleChange('cape', v)} />
//         <Slider label="CIN (Convective Inhibition)" unit="J/kg" min={-50} max={0} value={simulatorParameters.cin} onChange={(v) => handleChange('cin', v)} />
//         <Slider label="Cloud Top Temp Drop" unit="°C/30min" min={0} max={20} value={simulatorParameters.cttDrop} onChange={(v) => handleChange('cttDrop', v)} />
//       </div>
//     </div>
//   );
// };
...
//       </div>
//       <input type="range" min={min} max={max} value={value} onChange={(e) => onChange(e.target.value)} className="w-full accent-cyan-500 cursor-pointer" />
//     </div>
//   );
// }
