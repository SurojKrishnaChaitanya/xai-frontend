...
//   // Push real-time assistant observations whenever riskData updates
//   useEffect(() => {
//     if (!riskData) return;
...
//   return (
//     <div className="p-5 bg-slate-900/90 text-white rounded-xl border border-slate-800 flex flex-col h-105 shadow-xl backdrop-blur-md">
//       {/* Header */}
...
//           </div>
//         </div>
//         <div className="flex items-center gap-1.5 text-[10px] text-emerald-400 bg-emerald-950/50 border border-emerald-800/60 px-2 py-0.5 rounded-full">
...
//                 msg.sender === 'user'
//                   ? 'bg-cyan-600/90 border-cyan-500 text-white rounded-tr-none'
//                   : 'bg-slate-950/80 border-slate-800 text-slate-300 rounded-tl-none'
//               }`}
//             >
//               <p>{msg.text}</p>
...
//         {isThinking && (
//           <div className="flex items-center gap-2 text-xs text-slate-400 bg-slate-950/50 p-2.5 rounded-lg border border-slate-800 w-fit">
...
//             className="text-[10px] whitespace-nowrap bg-slate-800/80 hover:bg-slate-700 border border-slate-700 text-slate-300 px-2.5 py-1 rounded-full transition-colors flex items-center gap-1 shrink-0"
//           >
//             <span>{prompt}</span>
...
//           className="px-3.5 py-2 bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-semibold rounded-lg transition-colors flex items-center gap-1.5"
//         >
